...
- **Bureau v1 livré** (2026-07-03) : Astro+Svelte en place, moteur de fenêtres, bureau catégories naturelles, scène restaurée (`src/data/session.js`), apps dossier/note/lecteur/image, recherche v0, matière fictive plausible (`src/data/content.js`, avec refs multi-appartenance et questions créatives). Style neutre en attendant 070 ; sons en attendant 050.
