...
- Méthode actuelle : **construire d'abord, documenter ensuite** (fonctionnalité → conception → dev → test → doc si nécessaire). La bible restante (040/050/060/070) s'écrira en suivant le projet.
